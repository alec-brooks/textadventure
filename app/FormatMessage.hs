...
formatMessage GameState {gameError = Just e} = wrap $ show e
...
helpText = wrapText 80 "This is a game that is played using commands that you issue in order to explore and interact with the world around you \
