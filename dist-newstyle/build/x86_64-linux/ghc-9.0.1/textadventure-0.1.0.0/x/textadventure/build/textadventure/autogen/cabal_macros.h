...
/* package textadventure-0.1.0.0 */
#ifndef VERSION_textadventure
#define VERSION_textadventure "0.1.0.0"
#endif /* VERSION_textadventure */
#ifndef MIN_VERSION_textadventure
#define MIN_VERSION_textadventure(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_textadventure */
...
#define CURRENT_COMPONENT_ID "textadventure-0.1.0.0-inplace-textadventure"
